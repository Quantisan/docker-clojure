...
(deftest image-variants-test
  (testing "generates the expected set of variants"
    (is (= #{{:base-image "openjdk:8", :distro "debian", :build-tool "lein"
              :maintainer "Paul Lam <paul@quantisan.com>", :docker-tag "lein-2.8.1", :build-tool-version "2.8.1"}
             {:base-image "openjdk:8", :distro "debian", :build-tool "boot",
              :maintainer "Wes Morgan <wesmorgan@icloud.com>", :docker-tag "boot-2.8.1", :build-tool-version "2.8.1"}
             {:base-image "openjdk:8", :distro "debian", :build-tool "tools-deps"
              :maintainer "Kirill Chernyshov <delaguardo@gmail.com>", :docker-tag "tools-deps-1.9.0.397"
              :build-tool-version "1.9.0.397"}
             {:base-image "openjdk:8", :distro "alpine", :build-tool "lein"
              :maintainer "Wes Morgan <wesmorgan@icloud.com>", :docker-tag "lein-2.8.1-alpine"
              :build-tool-version "2.8.1"}
             {:base-image "openjdk:8", :distro "alpine", :build-tool "boot"
              :maintainer "Wes Morgan <wesmorgan@icloud.com>", :docker-tag "boot-2.8.1-alpine"
              :build-tool-version "2.8.1"}
             {:base-image "openjdk:8", :distro "alpine", :build-tool "tools-deps"
              :maintainer "Kirill Chernyshov <delaguardo@gmail.com>", :docker-tag "tools-deps-1.9.0.397-alpine"
              :build-tool-version "1.9.0.397"}
             {:base-image "openjdk:11", :distro "debian", :build-tool "lein"
              :maintainer "Paul Lam <paul@quantisan.com>", :docker-tag "openjdk-11-lein-2.8.1"
              :build-tool-version "2.8.1"}
             {:base-image "openjdk:11", :distro "debian", :build-tool "boot"
              :maintainer "Wes Morgan <wesmorgan@icloud.com>", :docker-tag "openjdk-11-boot-2.8.1"
              :build-tool-version "2.8.1"}
             {:base-image "openjdk:11", :distro "debian", :build-tool "tools-deps"
              :maintainer "Kirill Chernyshov <delaguardo@gmail.com>", :docker-tag "openjdk-11-tools-deps-1.9.0.397"
              :build-tool-version "1.9.0.397"}
             {:base-image "openjdk:11", :distro "alpine", :build-tool "lein"
              :maintainer "Wes Morgan <wesmorgan@icloud.com>", :docker-tag "openjdk-11-lein-2.8.1-alpine"
              :build-tool-version "2.8.1"}
             {:base-image "openjdk:11", :distro "alpine", :build-tool "boot"
              :maintainer "Wes Morgan <wesmorgan@icloud.com>", :docker-tag "openjdk-11-boot-2.8.1-alpine"
              :build-tool-version "2.8.1"}
             {:base-image "openjdk:11", :distro "alpine", :build-tool "tools-deps"
              :maintainer "Kirill Chernyshov <delaguardo@gmail.com>"
              :docker-tag "openjdk-11-tools-deps-1.9.0.397-alpine", :build-tool-version "1.9.0.397"}}
